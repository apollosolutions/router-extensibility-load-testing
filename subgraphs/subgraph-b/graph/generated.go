...
func (ec *executionContext) _Entity_findLocationByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNLocation2ᚖrouterᚑcoprocessorᚑprojᚋsubgraphᚑbᚋgraphᚋmodelᚐLocation(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_locations(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Location)
	fc.Result = res
	return ec.marshalNLocation2ᚕᚖrouterᚑcoprocessorᚑprojᚋsubgraphᚑbᚋgraphᚋmodelᚐLocationᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_location(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Location)
	fc.Result = res
	return ec.marshalOLocation2ᚖrouterᚑcoprocessorᚑprojᚋsubgraphᚑbᚋgraphᚋmodelᚐLocation(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNLocation2routerᚑcoprocessorᚑprojᚋsubgraphᚑbᚋgraphᚋmodelᚐLocation(ctx context.Context, sel ast.SelectionSet, v model.Location) graphql.Marshaler {
	return ec._Location(ctx, sel, &v)
}

func (ec *executionContext) marshalNLocation2ᚕᚖrouterᚑcoprocessorᚑprojᚋsubgraphᚑbᚋgraphᚋmodelᚐLocationᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Location) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNLocation2ᚖrouterᚑcoprocessorᚑprojᚋsubgraphᚑbᚋgraphᚋmodelᚐLocation(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNLocation2ᚖrouterᚑcoprocessorᚑprojᚋsubgraphᚑbᚋgraphᚋmodelᚐLocation(ctx context.Context, sel ast.SelectionSet, v *model.Location) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOLocation2ᚖrouterᚑcoprocessorᚑprojᚋsubgraphᚑbᚋgraphᚋmodelᚐLocation(ctx context.Context, sel ast.SelectionSet, v *model.Location) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Location(ctx, sel, v)
